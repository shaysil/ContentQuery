...
var ListService = /** @class */ (function () {
    ...
    ListService.prototype.getListItemsByQuery = function (webUrl, listId, camlQuery) {
        ...
        return new Promise(function (resolve, reject) {
            var endpoint = Text.format("{0}/_api/web/lists(guid'{1}')/GetItems?$expand=FieldValuesAsText,FieldValuesAsHtml", webUrl, listId);
            var data = {
                query: {
            ...
            _this.spHttpClient.post(endpoint, SPHttpClient.configurations.v1, options)
    ...
    ListService.prototype.getListTitlesFromWeb = function (webUrl) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var endpoint = Text.format("{0}/_api/web/lists?$select=Id,Title&$filter=(IsPrivate eq false) and (IsCatalog eq false) and (Hidden eq false)", webUrl);
    ...
    ListService.prototype.getListFields = function (webUrl, listId, selectProperties, orderBy) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var endpoint = Text.format("{0}/_api/web/lists(guid'{1}')/Fields?$select={2}&$orderby={3}", webUrl, listId, selectProps, order);
            _this.spHttpClient.get(endpoint, SPHttpClient.configurations.v1).then(function (response) {
                if (response.ok) {
