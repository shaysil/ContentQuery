...
export declare class PackageMetadata {
    ...
    constructor(packageJsonPath: string, packageJson: IPackageJson, aedocSupported: boolean);
}
/**
...
export declare class PackageMetadataManager {
    ...
    static writeTsdocMetadataFile(packageJsonFolder: string): void;
    constructor(packageJsonLookup: PackageJsonLookup, logger: ILogger);
    /**
