...
const ApiModel_1 = require("../api/model/ApiModel");
const ApiClass_1 = require("../api/model/ApiClass");
const ApiPackage_1 = require("../api/model/ApiPackage");
const ApiEntryPoint_1 = require("../api/model/ApiEntryPoint");
const ApiMethod_1 = require("../api/model/ApiMethod");
const ApiNamespace_1 = require("../api/model/ApiNamespace");
const ApiInterface_1 = require("../api/model/ApiInterface");
const ApiPropertySignature_1 = require("../api/model/ApiPropertySignature");
const ReleaseTag_1 = require("../aedoc/ReleaseTag");
const ApiProperty_1 = require("../api/model/ApiProperty");
const ApiMethodSignature_1 = require("../api/model/ApiMethodSignature");
const ApiEnum_1 = require("../api/model/ApiEnum");
const ApiEnumMember_1 = require("../api/model/ApiEnumMember");
const ExcerptBuilder_1 = require("./ExcerptBuilder");
const ApiConstructor_1 = require("../api/model/ApiConstructor");
const ApiConstructSignature_1 = require("../api/model/ApiConstructSignature");
const ApiFunction_1 = require("../api/model/ApiFunction");
const ApiIndexSignature_1 = require("../api/model/ApiIndexSignature");
const ApiVariable_1 = require("../api/model/ApiVariable");
const ApiTypeAlias_1 = require("../api/model/ApiTypeAlias");
const ApiCallSignature_1 = require("../api/model/ApiCallSignature");
...
class ApiModelGenerator {
    constructor(collector) {
        ...
        this._apiModel = new ApiModel_1.ApiModel();
    }
    get apiModel() {
    ...
    buildApiPackage() {
        ...
        const apiPackage = new ApiPackage_1.ApiPackage({
            name: this._collector.workingPackage.name,
            docComment: packageDocComment
        });
        this._apiModel.addMember(apiPackage);
        const apiEntryPoint = new ApiEntryPoint_1.ApiEntryPoint({ name: '' });
    ...
    _processDeclaration(astDeclaration, exportedName, parentApiItem) {
        ...
        if (releaseTag === ReleaseTag_1.ReleaseTag.Internal || releaseTag === ReleaseTag_1.ReleaseTag.Alpha) {
    ...
    _processApiCallSignature(astDeclaration, exportedName, parentApiItem) {
        ...
        const canonicalReference = ApiCallSignature_1.ApiCallSignature.getCanonicalReference(overloadIndex);
        ...
        if (apiCallSignature === undefined) {
            ...
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiCallSignature = new ApiCallSignature_1.ApiCallSignature({ docComment, releaseTag, parameters, overloadIndex,
    ...
    _processApiConstructor(astDeclaration, exportedName, parentApiItem) {
        ...
        const overloadIndex = this._getOverloadIndex(astDeclaration);
        const canonicalReference = ApiConstructor_1.ApiConstructor.getCanonicalReference(isStatic, overloadIndex);
        ...
        if (apiConstructor === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiConstructor = new ApiConstructor_1.ApiConstructor({ docComment, releaseTag, isStatic, parameters, overloadIndex,
                excerptTokens });
    ...
    _processApiClass(astDeclaration, exportedName, parentApiItem) {
        ...
        const canonicalReference = ApiClass_1.ApiClass.getCanonicalReference(name);
        ...
        if (apiClass === undefined) {
            ...
            const excerptTokens = ExcerptBuilder_1.ExcerptBuilder.build({
                startingNode: astDeclaration.declaration,
                nodeToStopAt: ts.SyntaxKind.FirstPunctuation,
                nodesToCapture
            });
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiClass = new ApiClass_1.ApiClass({ name, docComment, releaseTag,
    ...
    _processApiConstructSignature(astDeclaration, exportedName, parentApiItem) {
        const overloadIndex = this._getOverloadIndex(astDeclaration);
        const canonicalReference = ApiConstructSignature_1.ApiConstructSignature.getCanonicalReference(overloadIndex);
        ...
        if (apiConstructSignature === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiConstructSignature = new ApiConstructSignature_1.ApiConstructSignature({ docComment, releaseTag, parameters, overloadIndex,
                excerptTokens, returnTypeTokenRange });
    ...
    _processApiEnum(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const canonicalReference = ApiEnum_1.ApiEnum.getCanonicalReference(name);
        ...
        if (apiEnum === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiEnum = new ApiEnum_1.ApiEnum({ name, docComment, releaseTag, excerptTokens });
    ...
    _processApiEnumMember(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const canonicalReference = ApiEnumMember_1.ApiEnumMember.getCanonicalReference(name);
        ...
        if (apiEnumMember === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiEnumMember = new ApiEnumMember_1.ApiEnumMember({ name, docComment, releaseTag,
    ...
    _processApiFunction(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const overloadIndex = this._getOverloadIndex(astDeclaration);
        const canonicalReference = ApiFunction_1.ApiFunction.getCanonicalReference(name, overloadIndex);
        ...
        if (apiFunction === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiFunction = new ApiFunction_1.ApiFunction({ name, docComment, releaseTag, parameters, overloadIndex,
                excerptTokens, returnTypeTokenRange });
    ...
    _processApiIndexSignature(astDeclaration, exportedName, parentApiItem) {
        const overloadIndex = this._getOverloadIndex(astDeclaration);
        const canonicalReference = ApiIndexSignature_1.ApiIndexSignature.getCanonicalReference(overloadIndex);
        ...
        if (apiIndexSignature === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiIndexSignature = new ApiIndexSignature_1.ApiIndexSignature({ docComment, releaseTag, parameters, overloadIndex,
                excerptTokens, returnTypeTokenRange });
    ...
    _processApiInterface(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const canonicalReference = ApiInterface_1.ApiInterface.getCanonicalReference(name);
        ...
        if (apiInterface === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiInterface = new ApiInterface_1.ApiInterface({ name, docComment, releaseTag, excerptTokens, extendsTokenRanges });
    ...
    _processApiMethod(astDeclaration, exportedName, parentApiItem) {
        ...
        const isStatic = (astDeclaration.modifierFlags & ts.ModifierFlags.Static) !== 0;
        const overloadIndex = this._getOverloadIndex(astDeclaration);
        const canonicalReference = ApiMethod_1.ApiMethod.getCanonicalReference(name, isStatic, overloadIndex);
        ...
        if (apiMethod === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiMethod = new ApiMethod_1.ApiMethod({ name, docComment, releaseTag, isStatic, parameters, overloadIndex,
                excerptTokens, returnTypeTokenRange });
    ...
    _processApiMethodSignature(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const overloadIndex = this._getOverloadIndex(astDeclaration);
        const canonicalReference = ApiMethodSignature_1.ApiMethodSignature.getCanonicalReference(name, overloadIndex);
        ...
        if (apiMethodSignature === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiMethodSignature = new ApiMethodSignature_1.ApiMethodSignature({ name, docComment, releaseTag, parameters, overloadIndex,
                excerptTokens, returnTypeTokenRange });
    ...
    _processApiNamespace(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const canonicalReference = ApiNamespace_1.ApiNamespace.getCanonicalReference(name);
        ...
        if (apiNamespace === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiNamespace = new ApiNamespace_1.ApiNamespace({ name, docComment, releaseTag, excerptTokens });
    ...
    _processApiProperty(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const isStatic = (astDeclaration.modifierFlags & ts.ModifierFlags.Static) !== 0;
        const canonicalReference = ApiProperty_1.ApiProperty.getCanonicalReference(name, isStatic);
        ...
        if (apiProperty === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiProperty = new ApiProperty_1.ApiProperty({ name, docComment, releaseTag, isStatic, excerptTokens, propertyTypeTokenRange });
    ...
    _processApiPropertySignature(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const canonicalReference = ApiPropertySignature_1.ApiPropertySignature.getCanonicalReference(name);
        ...
        if (apiPropertySignature === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiPropertySignature = new ApiPropertySignature_1.ApiPropertySignature({ name, docComment, releaseTag,
    ...
    _processApiTypeAlias(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const canonicalReference = ApiTypeAlias_1.ApiTypeAlias.getCanonicalReference(name);
        ...
        if (apiTypeAlias === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiTypeAlias = new ApiTypeAlias_1.ApiTypeAlias({ name, docComment, releaseTag, excerptTokens });
            parentApiItem.addMember(apiTypeAlias);
        }
    }
    _processApiVariable(astDeclaration, exportedName, parentApiItem) {
        const name = !!exportedName ? exportedName : astDeclaration.astSymbol.localName;
        const canonicalReference = ApiVariable_1.ApiVariable.getCanonicalReference(name);
        ...
        if (apiVariable === undefined) {
            ...
            const docComment = this._collector.fetchMetadata(astDeclaration).tsdocComment;
            const releaseTag = this._collector.fetchMetadata(astDeclaration.astSymbol).releaseTag;
            apiVariable = new ApiVariable_1.ApiVariable({ name, docComment, releaseTag, excerptTokens, variableTypeTokenRange });
