...
class ApiExtractorTask extends RSCTask_1.RSCTask {
    ...
    executeTask() {
        ...
        const extractorConfig = ApiExtractorRunner.apiExtractor.Extractor.loadConfigObject(this._getApiExtractorConfigFilePath(this.buildConfig.rootPath));
        const apiExtractorRunner = new ApiExtractorRunner(extractorConfig, extractorOptions, this.buildFolder, this._terminalProvider);
