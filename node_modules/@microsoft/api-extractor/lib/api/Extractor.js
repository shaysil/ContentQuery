...
class Extractor {
    ...
    processProject(options) {
        ...
        const packageBaseName = path.basename(collector.package.name);
        ...
        PackageMetadataManager_1.PackageMetadataManager.writeTsdocMetadataFile(collector.package.packageFolder);
        if (this._localBuild) {
    ...
    _generateRollupDtsFiles(collector) {
        const packageFolder = collector.package.packageFolder;
        ...
        if (dtsRollup.enabled) {
            ...
            if (!mainDtsRollupPath) {
                ...
                const resolvedTypings = path.resolve(packageFolder, collector.package.packageJson.typings);
