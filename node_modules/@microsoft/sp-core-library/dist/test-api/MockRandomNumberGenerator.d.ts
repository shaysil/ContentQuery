 ...
 */
export default class MockRandomNumberGenerator implements IRandomNumberGenerator {
    private static MULTIPLIER;
    private static MODULUS;
    private static MODULUS_HIGH;
    private static MODULUS_LOW;
    private _seed;
