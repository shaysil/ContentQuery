...
export declare function isEnter(e: KeyboardEvent | ReactKeyboardEvent<void>): boolean;
...
export declare function isKey(keyCode: number, e: KeyboardEvent | ReactKeyboardEvent<any>, allowAlt?: boolean, allowCtrl?: boolean, allowShift?: boolean): boolean;
