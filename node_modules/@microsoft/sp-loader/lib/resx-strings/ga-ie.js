define([], function() {
  var strings = {
    ...
    "_FmFyAWZ1md7Z1R+V8t2S2Q": {
      "errorLoadingDebugScriptHTTPS": "Tharla earráid le linn don script dífhabhtaithe a bheith á lódáil. Cinntigh go bhfuil an freastalaí ag rith agus go bhfuil URL an pharaiméadair “{0}” ceart.",
      "errorLoadingDebugScriptHTTP": "Tharla earráid le linn don script dífhabhtaithe a bheith á lódáil. Cinntigh go bhfuil an freastalaí ag rith, go bhfuil URL an pharaiméadair “{0}, agus go bhfuil cead agat scripteanna neamhshlána a lódáil. Smaoinigh freisin ar dheimhniú forbartha a úsáid agus ar scripteanna dífhabhtacha a chur i bhfeidhm thar HTTPS.",
      "errorLoadingDebugScriptMalformed": "Tharla earráid le linn don script dífhabhtaithe a bheith á lódáil. Is cosúil go bhfuil an URL dífhabhtaithe ({0}) míchumtha.",
      "errorLoadingDebugScriptUnknown": "Tharla earráid neamhaithind le linn don script dífhabhtaithe a bheith á lódáil.",
      "errorLoadingDebugLoaderTitle": "Tharla earráid le linn don lódálaí dhífhabhtaithe a bheith á lódáil.",
      "errorLoadingDebugManifestTitle": "Tharla earráid le linn do na comhaid léirithe dhífhabhtacha a bheith á lódáil.",
      "errorLoadingUnknownTitle": "Tharla earráid le linn do na scripteanna dífhabhtaithe a bheith á lódáil."
    },
    ...
    "_mraBnnuq2J9WjrAcnw9QNA": {
      "debugManifestErrorDetail": "Tharla earráid le linn do na comhaid léirithe dhífhabhtacha a bheith á lódáil.",
      "debugManifestErrorDismissButtonText": "Ruaig"
    },
    "_upo3vfLFBbnbzl2hKy2TwA": {
      "allowDebugManifestsTitle": "An bhfuil fonn ort scripteanna a dhífhabhtú?",
      "allowDebugLoaderTitle": "An bhfuil fonn ort lódálaí dífhabhtaithe a cheadú?",
      "allowDebugLoaderAndManifestsTitle": "An bhfuil fonn ort an lódálaí dífhabhtaithe a cheadú agus scripteanna a dhífhabhtú?",
      "debugManifestLoadingWarning": "RABHADH: Tá scripteanna neamhshlána ar an leathanach seo, scripteanna a d’fhéadfadh dochar a dhéanamh do do ríomhaire má rithfear iad! Ná lean ar aghaidh mura bhfuil iontaoibh agat as an bhforbróir agus mura dtuigeann tú na baoil.",
    ...
    "_g7G0QHJ5bQYlxe+lk+DcxA": {
      ...
      "ModuleLazyLoadingDelayLabel": "Tá lódáil an mhodúil curtha siar",
