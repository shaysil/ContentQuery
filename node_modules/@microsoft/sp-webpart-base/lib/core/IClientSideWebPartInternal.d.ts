 ...
 */
export interface IClientSideWebPartInternal extends IPropertyPaneConsumer, IViewportAwareWebPart {
    domElement: HTMLElement;
    accessibleTitle: string;
    previewImageUrl: string;
    context: WebPartContext;
    _initializeContext(context: WebPartContext): void;
    _internalInitialize(webPartContext: WebPartContext, addedFromPersistedData: boolean | undefined, mode: DisplayMode): void;
