...
export declare abstract class BaseComponentContext implements IDisposable {
    ...
    /** @internal */
    constructor(parameters: _IComponentContextParameters);
    /**
    ...
    /**
     * The instance of GraphHttpClient created for this instance of component
     * @beta
     * @deprecated Use {@link BaseComponentContext.msGraphClientFactory} instead
     */
 ...
 * @internal
 */
export declare class _ComponentBaseKillSwitches {
    /**
     * Killswitch to safe guard dynamic data beta apis.
     */
    static isDynamicDataGetPropertyValueKillSwitchActivated(): boolean;
    /**
     * Killswitch to safe guard the logic to force load the legacy fabric css for
     * third party components.
     */
    static isStopLoadingLegacyFabricCSSKillSwitchActivated(): boolean;
}
 ...
 * @internal
 */
export declare interface _IComponentContextParameters {
    /**
 ...
 * @public
 */
declare interface IRawStyle extends IRawStyleBase {
    /**
...
declare type IReadonlyRawStyle = Readonly<IRawStyle>;
 ...
 * @internal
 */
export declare class _LegacyThirdPartyFabricCoreLoader {
    /**
