 ...
 * @public
 */
export declare interface IODataChangeToken {
    /**
 ...
 * @public
 */
export declare interface IODataContextWebInformation {
    /**
...
export declare interface IODataList {
    ...
    Description: string;
    /**
     * A hidden list does not appear on the Documents and Lists page, Quick Launch bar,
     * the Modify Site Content page, or the Add Column page as an option for lookup fields.
     */
    Hidden: boolean;
    /**
 ...
 * @public
 */
export declare interface IODataListItem {
    ID: number;
    /**
 ...
 * @public
 */
export declare interface IODataNavigationNode {
    /**
 ...
 * @public
 */
export declare interface IODataNavigationNodeCollection {
    /**
 ...
 * @public
 */
export declare interface IODataUser {
    Id: number;
    /**
    ...
    LoginName: string;
    /**
     * This enumeration has a FlagsAttribute attribute that allows a bitwise combination of
     * its member values.
     * @remarks
     *
     * Values:
    ...
    Title: string;
    /**
     * Gets the information of the user that contains the user's name identifier and the
     * issuer of the user's name identifier.
     */
    UserId: IODataUserId;
}

/**
 * Represents an OData SP.UserCustomAction object.  For more information about this object
 * see the MSDN documentation here:
 * {@link https://msdn.microsoft.com/en-us/library/office/dn531432.aspx#bk_UserCustomAction}
 *
 * @public
 */
export declare interface IODataUserCustomAction {
    /**
    ...
    /**
     * Gets or sets a value that specifies an implementation specific XML fragment that
     * determines user interface properties of the custom action.
     */
    ...
    Description: string;
    /**
     * Gets or sets a value that specifies an implementation-specific value that determines
     * the position of the custom action in the page.
     */
    Group: string;
    /**
    ...
    Location: string;
    /**
     * Gets or sets the value that specifies the identifier of the object associated with
     * the custom action.
     */
     ...
     *
     * @remarks
     * Represents an SP.UserCustomActionRegistrationType value:
     * None = 0; List = 1; ContentType = 2; ProgId = 3; FileType = 4.
     */
    ...
    ScriptBlock: string;
    /**
     * Gets or sets a value that specifies the URI of a file which contains the ECMAScript to execute
     * on the page.
     */
    ScriptSrc: string;
    /**
     * Gets or sets the value that specifies an implementation-specific value that determines the
     * order of the custom action that appears on the page.
     */
    Sequence: number;
    /**
 ...
 * @public
 */
declare interface IODataUserId {
    /**
 ...
 * @public
 */
export declare interface IODataWeb {
    /**
