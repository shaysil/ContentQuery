...
export default class ClientSideCustomAction {
     ...
     */
    static _tryCreateFromDebugData(location: string, clientSideComponentId: Guid, clientSideComponentProperties?: string, sequence?: number): ClientSideCustomAction | undefined;
    /**
