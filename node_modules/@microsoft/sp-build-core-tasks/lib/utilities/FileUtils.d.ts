 ...
 * @param filenameCallback - Callback for performing operations with the original and final file name.
 */
export declare function renameWithHash(gulpStream: NodeJS.ReadWriteStream, getFilename: (hash: string, originalFilename: string) => string, filenameCallback: (filename: string, originalFilename: string) => void, modifyFileContents?: (hash: string, file: gulpUtil.File, encoding: string) => gulpUtil.File): NodeJS.ReadWriteStream;
