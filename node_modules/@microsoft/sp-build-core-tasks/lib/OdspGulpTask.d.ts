...
declare abstract class OdspGulpTask<TASK_CONFIG> extends GulpTask<TASK_CONFIG> {
    ...
    resolveResources(localizedResources: string[], buildSingleLocale?: string, parentTask?: GulpTask<any>): IResolveResourcesResult;
    protected getDefaultProperties(): IOdspGulpTaskProperties;
