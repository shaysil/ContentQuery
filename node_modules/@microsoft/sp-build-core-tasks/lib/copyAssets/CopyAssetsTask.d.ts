...
export interface IWebpackMultiCompilerStatsObject {
    children?: IWebpackStatsObject[];
}
...
export declare class CopyAssetsTask extends OdspGulpTask<ICopyAssetsTaskConfig> {
    ...
    private _processExternalsForEntry;
    private _selectDefaultLocaleForResource;
    private _fillLocalizedPaths;
    private _fillLocalizedPath;
    /**
     ...
     * already.
     */
    private _insertGlobalRegisterCodeIfNecessary;
}
