 ...
 * @internal
 */
export declare class _AadConstants {
    /**
     ...
     */
    static readonly SPFX_SINGLE_SIGN_ON_REPLY_URL: string;
    /**
     ...
     */
    static readonly REDIRECT_QUERY_PARAM: string;
    /**
     ...
     */
    static readonly PRE_AUTHORIZED_APP_PRINCIPAL_ID: string;
    /**
     * This error code is returned from Azure AD when the SPO Web Application Service Principal has not consented
     * to the requested app.
     */
    static readonly APP_DID_NOT_CONSENT_ERROR_CODE: string;
    /**
     * This error code is returned from Azure AD when the user tries to access AAD with an unmanaged device.
     */
    static readonly UNMANAGED_DEVICE_ERROR_CODE: string;
    /**
     ...
     */
    static readonly RESOLVABLE_ERROR_CODES: Set<string>;
}
...
export declare class AadTokenProvider implements IAadTokenProvider {
   ...
   * @internal
   */
    _getTokenInternal(resourceEndpoint: string, configuration: IAadTokenProviderConfiguration): Promise<string>;
    /**
 ...
 * @internal
 */
export declare class _AadTokenProviders {
     ...
     * @internal
     */
    static _initialize(configurable: IAadTokenProvider, preAuthorizedConfig: IAadTokenProviderConfiguration): void;
    /**
     ...
     */
    static readonly configurable: IAadTokenProvider;
    /**
     ...
     */
    static readonly preAuthorizedConfiguration: IAadTokenProviderConfiguration;
}
 ...
 * @internal
 */
declare class AdalAuthContextManager {
 ...
 * @internal
 */
export declare class _GraphHttpClientContext {
    /**
     * The service key for GraphHttpClientContext.
     */
    static readonly serviceKey: ServiceKey<_GraphHttpClientContext>;
     ...
     */
    initialize(webServerRelativeUrl: string, graphEndpointUrl: string): void;
    /**
 ...
 * @internal
 */
declare interface IAdalJsModule {
 ...
 * @alpha
 */
export declare interface IFetchProvider {
    /**
 ...
 * @internal
 */
declare interface ISPOBOFlowParameters {
 ...
 * @internal
 */
declare interface ITokenProvider {
    /**
     * Fetches the AAD OAuth2 token for a resource if the user that's currently logged in has
     * access to that resource.
     *
